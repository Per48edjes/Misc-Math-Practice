...
\section*{Solution}
  ...
  \begin{lemmaproof}
    ...
    \[
      m < j_{c+1} < (c+1) \log_{2}{10} + 1.
    \]
    Finally, since $\log_{2}{10}$ is irrational and $m \leq j_{c+1} - 1$ ($m, j_{c+1}$ are integers and $m < j_{c+1}$), we have demonstrated that
    \[
      m \leq j_{c + 1} - 1 < (c + 1) \log_{2}{10} \implies m < (c + 1) \log_{2}{10}.
    \]
